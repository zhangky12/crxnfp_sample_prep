# Visualize the distribution of sampled pairs 
...
if __name__ == "__main__":
    ...
    plt.hist(pair_similarity, bins=200, edgecolor='black', alpha=0.7)
    ...
    # Save plot to file
    plt.savefig("tanimoto_histogram_1M_uniform.png", dpi=300, bbox_inches='tight')
